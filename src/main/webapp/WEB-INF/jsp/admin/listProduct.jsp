...
<script>
    ...
    function showProductEditModal(obj) {
        ...
        //获取page.start的参数
        var pagestatus=getUrlParam('start');
        ...
        <table id="productDetail" class="table table-striped table-bordered table-hover table-condensed text-center">
            ...
            <c:forEach items="${ps}" var="p" varStatus="status">
                <tr>
                    ...
                    <td><a deleteLink="true" href="admin_product_delete?id=${p.id}&start=${page.start}"><span
                ...
                <div class="modal-body">
                    <form method="post" id="productEditForm" action="admin_product_update">
                        <table id="productEditTable" class="editTable">
                            <tr>
                                <td>产品名称</td>
                                <td><input id="productEditName" name=name type="text" class="form-control"></td>
                            </tr>
                            <tr>
                                <td>产品小标题</td>
                                <td><input id="productEditSubTitle" name="subTitle" type="text" class="form-control"></td>
                            </tr>
                            <tr>
                                <td>原价格</td>
                                <td><input id="productEditOriginalPrice" value="0.00" name="originalPrice" type="number" step="0.01" class="form-control"></td>
                            </tr>
                            <tr>
                                <td>优惠价格</td>
                                <td><input id="productEditPromotePrice" value="0.00" name="promotePrice" type="number" step="0.01" class="form-control"></td>
                            </tr>
                            <tr>
                                <td>库存</td>
                                <td><input id="productEditStock" value="1" name="stock" type="number" class="form-control"></td>
                            </tr>
                            <tr class="submitTR">
                                <td colspan="2" align="center">
                                    <input type="hidden" name="id" id="productEditId" value="">
                                    <input type="hidden" name="start" id="productEditPageStatus" value="">
