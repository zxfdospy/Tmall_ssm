                        ...
                        $.get(
                            ...
                            function (result) {
                                if ("success" == result) {
                                    ...
                                    var sync="foresyncCartNumberAjax";
                                    $.get(
                                        sync,
                                        function (result) {
                                            if(result!="fail")
                                            console.log(result);
                                            $("a#cartTotalItemNumber strong").text(result);
                                        }
                                    )
                                } else {
            ...
            <div class="productPriceDiv">
                ...
                <div class="originalDiv">
                    ...
                    <span class="originalPrice">
                        <fmt:formatNumber type="number" value="${p.originalPrice/100}" minFractionDigits="2"/>
                    </span>
                </div>
                <div class="promotionDiv">
                    ...
                    <span class="promotionPrice">
                        <fmt:formatNumber type="number" value="${p.promotePrice/100}" minFractionDigits="2"/>
                    </span>
                </div>
            </div>
        </div>
